...
class MunicipalityAdminDashboardController extends Controller
{
   public function index()
   {
     ...
     return view('municipalityadmin.municipalityadmindashboard',compact('posts', 'basud_admins', 'capalonga_admins', 'daet_admins', 'panganiban_admins',  'labo_admins', 'mercedes_admins','paracale_admins','san_lorenzo_admins', 'san_vicente_admins', 'san_vicente_admins', 'sta_elena_admins', 'talisay_admins', 'employer','admins','municipality_admins','vinzons_admins'));
   }
}
